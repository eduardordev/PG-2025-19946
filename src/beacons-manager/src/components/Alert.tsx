            ...
            <div className="-mx-1.5 -my-1.5">
              <button
                ...
                className={`inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                  type === 'success' ? 'text-green-300 hover:bg-green-800 focus:ring-green-600' :
                  type === 'error' ? 'text-red-300 hover:bg-red-800 focus:ring-red-600' :
                  'text-blue-300 hover:bg-blue-800 focus:ring-blue-600'
                }`}
              >
